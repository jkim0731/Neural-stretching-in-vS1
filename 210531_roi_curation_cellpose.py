...
# ax[1].imshow(perFileMeanImg[35], cmap = 'gray')
# ax[1].axes.get_xaxis().set_visible(False)
# ax[1].axes.get_yaxis().set_visible(False)


#%%
perFileMeanImg = mimgs

#%%
perSession = {'mimgs': mimgs, 'frameIndsPerSession': frameIndsPerSession, 'frameInds': frameInds, 
              'snameList': snameList, 'sessionList': slist}
np.save('JK025_plane6_per_session.npy', perSession)