...
def save_results_and_fig(mouse, volume, training_volume_df, results_dir, penalty):
    ...
    logireg_results = {'accuracy_45': acc_45,
                       ...
                       'coeff_45': coeff_45,
                       'coeff_135': coeff_135}
    save_dir = results_dir / 'whisker_feature_discrim/session_discrim'
    save_dir.mkdir(parents=True, exist_ok=True)
    logireg_results_fn = save_dir / f'JK{mouse:03}_volume{volume}_session_discrim_logireg_results_{penalty}.npy'
    np.save(logireg_results_fn, logireg_results)

    fig_fn = save_dir / f'JK{mouse:03}_volume{volume}_session_discrim_logireg_accuracy_{penalty}.png'
